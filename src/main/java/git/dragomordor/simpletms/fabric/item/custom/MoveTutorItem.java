...
public class MoveTutorItem extends PokemonUseItem {
    ...
    public ActionResult processInteraction(ItemStack itemStack, PlayerEntity player, PokemonEntity target, Pokemon pokemon) {
        ...
        boolean canLearnMove = canLearnMove(pokemon, taughtMove);
    ...
    private boolean canLearnMove(Pokemon pokemon, MoveTemplate taughtMove) {
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
       ...
       if (player!= null) {
           if (player.getItemCooldownManager().isCoolingDown(this)) {
               ...
               tooltip.add(Text.literal(cooldownText.toString()).withColor(SimpleTMsMod.RED));
           }
       }
        ...
        if (SingleUse) {
            ...
            tooltip.add(Text.literal("Consumed after use").withColor(SimpleTMsMod.DARK_RED));
        }

        // Adds move type to tooltip
        // String moveType = this.moveType;
        // Check if the move type exists in the map
        // if (moveTypeColors.containsKey(this.moveType)) {
        if (moveTypeColors.containsKey(this.moveType)) {
            ...
            tooltip.add(Text.literal(this.moveType).withColor(moveTypeColors.get(this.moveType))); // Add the colored move type to the tooltip
        }
    }
